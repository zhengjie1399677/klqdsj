      ...
      <div className="flex justify-around items-center bg-blue-900/10 rounded border border-blue-900/30 py-1.5 px-2 flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-base font-mono text-cyan-300 font-bold">{vehicleCattleStats.summary.totalVehiclesToday} <span className="text-[10px] text-slate-500 font-sans font-normal">辆</span></div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-base font-mono text-amber-300 font-bold">{vehicleCattleStats.summary.totalCattleToday} <span className="text-[10px] text-slate-500 font-sans font-normal">头</span></div>
          </div>
        </div>
      </div>
      <div className="flex-1 min-h-0">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={vehicleCattleStats.trend} margin={{ top: 5, right: 10, left: -25, bottom: -5 }}>
            ...
            <Line type="monotone" dataKey="vehicles" name="车辆数" stroke="#3b82f6" strokeWidth={2} dot={{ r: 2 }} />
            <Line type="monotone" dataKey="cattle" name="牛只数" stroke="#f59e0b" strokeWidth={2} dot={{ r: 2 }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
